    ...
    <div>
        <div className='ml-3 mt-8'>
                <div className='border border-gray-600 rounded-lg p-3  bg-[#101017]  mt-3 '>
                    ...
                    <div className='p-2' > 
                      <div className='flex '>
                        <img className='' src='https://terraria.wiki.gg/images/1/12/Brain_of_Confusion.png'/> <Link to='/acs/BrainOfConfusion'  className='ml-1 hover:underline hover:text-blue-500 duration-200 text-sm ' >Brain of Confusion</Link>
                      </div>
