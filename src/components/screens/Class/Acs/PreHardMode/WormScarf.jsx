...
export const WormScarf = () => {
  return (
    <div className={styles.main}>
        <h1 className=""><a className='font-bold'>The Worm Scarf </a>is a pre-Hardmode accessory that reduces incoming damage by 17%. This damage reduction from this item is calculated after defense is applied:
