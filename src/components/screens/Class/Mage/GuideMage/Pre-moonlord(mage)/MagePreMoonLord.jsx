                ...
                <div className='ml-2'>
                  <div className='border border-gray-600 rounded-lg p-3  bg-[#101017]  mt-3'>
                    ...
                    <div className='flex mb-2'>
                      <img className='' src='https://terraria.wiki.gg/images/f/fc/Nebula_Blaze.png'/> <Link className='' to={'/mage/NebulaBlaze'}><h1 className='hover:underline hover:text-blue-500 duration-200 ml-2'>Nebula Blaze</h1></Link>
                    </div>     
                  </div>
                  <div className='border border-gray-600 rounded-lg p-3  bg-[#101017]  mt-3'>
