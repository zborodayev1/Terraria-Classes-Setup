            ...
            <div className='flex'>
              <div className='ml-2'>
                ...
                <div className='border border-gray-600 rounded-lg p-3 bg-[#101017]  mt-3'>
                  ...
                  <div className='flex'>
                    <img src='https://terraria.wiki.gg/images/2/24/Titanium_armor_%28old%29.png' /> <Link className='h-6 mt-2' to={'/meleeArmor/titanumArmor'}><h1 className='   hover:underline hover:text-blue-500 duration-200 ml-1'>Titanium armor</h1></Link>
                  </div>
                </div>
                <div className='border border-gray-600 rounded-lg p-3 bg-[#101017]  mt-3'>
