          ...
          <div className='flex'>
              <div className='w-52'>
                  ...
                  <div className='flex mt-3'>
                    <img className='' src='https://terraria.wiki.gg/images/d/d4/Jungle_armor.png'/> <h1 className='mt-2 ml-2 font-bold' >Volcano</h1>
                  </div>
              </div>   
              ...
              <div className='w-52 ml-2'>
                  ...
                  <div className='flex mt-3' >
                  <img className='w-4 h-5' src='https://terraria.wiki.gg/images/b/b6/Stinger.png'/> <Link to='/wiki/items/stinger'className='ml-1 text-sm   hover:underline hover:text-blue-500 duration-200  ' >Stingers</Link><h1 className='ml-1 text-sm text-white/75'>x10</h1>
                  </div>
                  <div className='flex mt-3' >
                  <img className='w-5 h-4' src='https://terraria.wiki.gg/images/6/61/Jungle_Spores.png'/> <Link to='/wiki/items/jungle_Spore'className='ml-2 text-sm   hover:underline hover:text-blue-500 duration-200  ' >Jungle Spores</Link><h1 className='ml-1 text-sm  text-white/75'>x32</h1>
                  </div>
                  <div className='flex mt-3' >
                  <img className='w-4 h-6' src='https://terraria.wiki.gg/images/f/ff/Vine.png'/> <Link to='/wiki/items/vine' className='ml-2 text-sm   hover:underline hover:text-blue-500 duration-200  ' >Vine</Link><h1 className='ml-1 text-sm  text-white/75'>x2</h1>
                  </div>
              </div>
