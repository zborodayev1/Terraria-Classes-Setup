...
export const SharpeningStation = () => {
  return (
    <div className={styles.main} >
        <h1 className='bg-forWiki-bgBrown p-2 roundet-md' ><a className='font-bold'>The Sharpening Station</a> is a furniture item found naturally <a className='font-bold'>generated in Underground Cabins in the Underground Jungle</a>. In Hardmode, it is also sold by the Merchant for 10 gold.
