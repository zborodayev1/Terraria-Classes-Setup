...
export const WrathPotion = () => {
  return (
    <div className={styles.main}>
        <h1 className='' >The Wrath Potion is a buff potion which grants the Wrath buff when consumed. The buff generally increases damage dealt by weapons by 10%. This lasts for 4 minutes</h1>
     <div>
