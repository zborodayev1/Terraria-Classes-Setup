          ...
          <div className='flex'>
              <div className='w-52'>
                  ...
                  <div className='flex mt-3'>
                    <img className='' src='https://terraria.wiki.gg/images/e/ec/Rage_Potion.png'/> <h1 className='ml-2' >Rage potion</h1>
                  </div>
              </div>   
              ...
              <div className='w-52 ml-2'>
                  ...
                  <div className='flex mt-3' >
                     <img className='' src='https://terraria.wiki.gg/images/9/9d/Hemopiranha.png'/> <h1 className='ml-2 ' >Hemopiranha</h1>
                  </div> 
                  <div className='flex mt-3' >
