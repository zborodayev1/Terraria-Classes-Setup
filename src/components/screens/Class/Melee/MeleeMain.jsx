      ...
      <div className='flex'>
          ...
          <div className='ml-3'>
            ...
            <div className='ml-2'>
              <h1>Weapons:</h1>
              <div className='flex'>
                <img  src='https://terraria.wiki.gg/images/9/98/Night%27s_Edge.png'/> <Link to={'/meleeWeapons/nightsEdge'}><h1 className=' text-blue-500 hover:underline'>Nights Edge </h1></Link>
              </div>
              <div>
                <h1>Armor:</h1>
                <div className='flex'>
                  <img className='w-7 h-12' src='https://terraria.wiki.gg/images/f/f1/Molten_armor.png' /> <Link to={'/meleeArmor/moltenArmor'}><h1 className='mt-3 text-blue-500 hover:underline'>Molten armor</h1></Link>
                </div>
              </div>
              <div>
                <h1>Buffs:</h1>
