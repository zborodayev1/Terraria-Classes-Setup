                ...
                <div className='ml-2'>
                  <div className='border border-gray-600 rounded-lg p-3  bg-[#101017]  mt-3'>
                    ...
                    <div className='flex mb-2 mt-2'>
                      <img className='' src='/Solar_Eruption.webp'/> <Link className='h-6' to={'/melee/SolarEruption'}><h1 className=' mt-2  hover:underline hover:text-blue-500 duration-200 ml-2'>Solar Eruption</h1></Link>
                    </div>
                    <div className='flex mb-2 mt-2'>
                      <img className='h-10 w-10' src='/Daybreak.webp'/> <Link className='h-6' to={'/melee/Daybreak'}><h1 className=' mt-2  hover:underline hover:text-blue-500 duration-200 ml-2'>Daybreak</h1></Link>
                    </div>
