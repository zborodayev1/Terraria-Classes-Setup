...
export const Muramasa = () => {
  return (
    <div className={styles.main}>
        <h1 className='bg-forWiki-bgBrown p-2 roundet-md' ><a className='font-bold'>The Muramasa</a> is a pre-Hardmode, post-Skeletron sword that has a slightly longer reach than the Phaseblade and has a fast attack speed. It is also one of the few autoswing swords that can be found during pre-Hardmode. When swung, it emits a small amount of blue light. On the Desktop version, Console version, and  Mobile version, striking an enemy with the Muramasa will generate a blue slash projectile from a random direction, hitting the enemy for 50% of the weapons damage (12 base damage).The smaller slashes also have 5 armor penetration.<a className='text-forWiki-links underline' >The Muramasa has a 1/7 (14.29%) chance of being obtained from the Locked Gold Chests found in the Dungeon, as well as a 1/7 (14.29%) chance of being obtained from Golden Lock Boxes.</a>
