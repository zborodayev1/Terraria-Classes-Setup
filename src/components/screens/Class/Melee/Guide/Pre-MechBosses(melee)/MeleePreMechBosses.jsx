...
export const MeleePreMechBosses = () => {
  return (
    <div className={styles.main} >
        <div className='ml-3 '>
            <div>
              <h1 className='text-xl my-2 font-bold'>Pre-Mech Bosses</h1>
            </div>  
            <div className='flex'>
              <div className='ml-2'>
                <div className='border border-gray-600 rounded-lg p-3 bg-[#101017]  mt-3'>
                  ...
                  <div className='flex'>
                    <img className='w-12 h-12' src='https://terraria.wiki.gg/images/e/ea/Ice_Sickle.png'/> <Link className='h-6 mt-2' to={'/meleeWeapons/iceSickle'}><h1 className='   hover:text-blue-500 duration-200  ml-2'>Ice Sickle </h1></Link>
                  </div>
                  <div className='flex'>
                    <img  src='https://terraria.wiki.gg/images/d/d2/Shadowflame_Knife.png'/> <Link className='h-6 mt-2' to={'/meleeWeapons/shadowflameKnife'}><h1 className='   hover:text-blue-500 duration-200  ml-2'>Shadowflame Knife </h1></Link>
                  </div>
                </div>
                <div className='border border-gray-600 rounded-lg p-3 bg-[#101017]  mt-3'>
                  <h1 className='font-bold'>Armor:</h1>
                  <div className='flex'>
                    <img src='https://terraria.wiki.gg/images/2/24/Titanium_armor_%28old%29.png' /> <Link className='h-6 mt-2' to={'/meleeArmor/titanumArmor'}><h1 className='   hover:text-blue-500 duration-200  ml-1'>Titanium armor</h1></Link>
                  </div>
                </div>
                <div className='border border-gray-600 rounded-lg p-3 bg-[#101017]  mt-3'>
