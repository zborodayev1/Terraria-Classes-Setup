              ...
              <div>
                ...
                <div className='ml-2'>
                  ...
                  <div className='border border-gray-600 rounded-lg p-3  bg-[#101017]  mt-3'>
                    <h1>Armor:</h1>
                    <div className='flex'>
                      <img src='https://terraria.wiki.gg/images/0/0c/Beetle_armor.png' /> <Link className='h-6 mt-2' to={'/meleeArmor/BeetleArmor'}><h1 className='  hover:text-blue-500 duration-200 ml-1'>Beetle armor</h1></Link>
                    </div>
                  </div>
                  <div className='border border-gray-600 rounded-lg p-3  bg-[#101017]  mt-3'>
                    <h1>Buffs:</h1>
