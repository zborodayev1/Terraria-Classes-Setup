          ...
          <div className='flex'>
              <div className='w-52'>
                  ...
                  <div className='flex mt-2'>
                    <img className='' src='https://terraria.wiki.gg/images/3/36/Megashark.png'/> <h1 className='mt-2 ml-2 font-bold' >Megashark</h1>
                  </div>
              </div>   
              ...
              <div className='w-52 ml-2'>
                  ...
                  <div className='flex mt-1' >
                    <img className='' src='https://terraria.wiki.gg/images/9/96/Minishark.png'/> <Link to='/ranged/MiniShark' className='ml-1 text-sm hover:underline hover:text-blue-500 duration-200' >Minishark</Link>
                  </div>
                  <div className='flex mt-2' >
