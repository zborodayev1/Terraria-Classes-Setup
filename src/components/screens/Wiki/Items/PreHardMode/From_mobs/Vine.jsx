...
export const Vine = () => {
  return (
    <div className={styles.main}>
        <h1 className='p-2 border border-gray-600  rounded-md bg-[#101017]' ><a className='font-bold  '>Vines</a> are crafting materials dropped by Man Eaters in the Underground Jungle biome with a 1/2 (50%) / 100% drop chance.</h1>
        <div className='p-2 border border-gray-600  rounded-md bg-[#101017] mt-5 w-72'>
            <h1 className='font-bold'>Obtained from</h1>
            <div className='flex mt-2' >
                <img src='https://terraria.wiki.gg/images/3/36/Man_Eater.gif'/> <h1 className='ml-2'>Man Eater</h1> <h1 className='ml-1 mr-1' >50% / </h1> <h1 className='text-yellow-500' >100%</h1>
            </div>
        </div>    
      <div>
