             ...
             <div className='flex'>
              ...
              <div>
                <div className='border border-gray-600 rounded-lg p-3 bg-[#101017] '>
                  ...
                  <div className='flex'>
                    <img className='' src='/Snapthorn.webp'/> <Link className='h-6' to={'/sum/pre-bosses/Snapthorn'}><h1 className='ml-1 hover:underline hover:text-blue-500 duration-200'>Snapthorn</h1></Link>
                  </div>
                  <div className='flex mt-3'>
                    <img className='' src='/Flinx_Staff.webp'/> <Link className='h-6' to={'/sum/pre-bosses/FlinxStaff'}><h1 className='ml-1 hover:underline hover:text-blue-500 duration-200'>Flinx Staff</h1></Link>
                  </div>
                </div>
                  <div className='border border-gray-600 rounded-lg p-3 bg-[#101017] mt-3'>
                    <h1 className="font-bold">Armor:</h1>
                    <div className='flex'>
                      <img className='' src='/Platinum_armor.webp' /> <Link className='h-6 mt-3' to={'/classes/platinumArmor'}><h1 className='ml-1 hover:underline hover:text-blue-500 duration-200'>Platinum armor</h1></Link>
                    </div>
                    <div className='flex mt-2'>
                      <img className='' src='/Flinx_Fur_Coat.webp' /> <Link className='' to={'/sum/pre-bosses/FlinxFurCoat'}><h1 className='ml-1 hover:underline hover:text-blue-500 duration-200'>Flinx Fur Coat</h1></Link>
                    </div>
                </div>
                <div className='border border-gray-600 rounded-lg p-3 bg-[#101017] mt-3'>
