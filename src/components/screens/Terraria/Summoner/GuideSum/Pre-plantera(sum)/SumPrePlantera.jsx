              ...
              <div className='flex'>
                ...
                <div className='ml-2'>
                  <div className='border border-gray-600 rounded-lg p-3 bg-[#101017] mt-3'>
                    ...
                    <div className='flex'>
                      <img className='' src='/Durendal.webp'/> <Link to={'/sum/pre-plantera/Durendal'}><h1 className=' mt-1 hover:underline hover:text-blue-500 duration-200 ml-2'>Durendal</h1></Link>
                    </div>
                    <div className='flex'>
                      <img className='' src='/Optic_Staff.webp'/> <Link to={'/sum/pre-plantera/OpticStaff'}><h1 className=' mt-1 hover:underline hover:text-blue-500 duration-200 ml-2'>Optic Staff</h1></Link>
                    </div>
                  </div>
                  <div className='border border-gray-600 rounded-lg p-3 bg-[#101017] mt-3'>
