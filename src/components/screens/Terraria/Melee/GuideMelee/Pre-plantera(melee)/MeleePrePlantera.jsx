                ...
                <div className='ml-2'>
                  <div className='border border-gray-600 rounded-lg p-3 bg-[#101017] mt-3'>
                    ...
                    <div className='flex mb-2'>
                      <img className='' src='/True_Nights_Edge.webp'/> <Link className='h-6 mt-2' to={'/melee/pre-plantera/trueNightsEdge'}><h1 className=' mt-2  hover:underline hover:text-blue-500 duration-200 ml-2'>True Nights Edge</h1></Link>
                    </div>
                    <div className='flex'>
                      <img  src='/Excalibur.webp'/> <Link className='h-6 mt-2' to={'/melee/pre-plantera/excalibur'}><h1 className='  hover:underline hover:text-blue-500 duration-200 ml-2'>Excalibur</h1></Link>
                    </div>
                  </div>
                  <div className='border border-gray-600 rounded-lg p-3 bg-[#101017] mt-3'>
                    <h1 className='font-bold'>Armor:</h1>
                    <div className='flex'>
                      <img src='/Turtle_armor.webp' /> <Link className='h-6 mt-2' to={'/melee/turtleArmor'}><h1 className='  hover:underline hover:text-blue-500 duration-200 ml-1'>Turtle armor</h1></Link>
                    </div>
                  </div>
                  <div className='border border-gray-600 rounded-lg p-3  bg-[#101017]  mt-3'>
