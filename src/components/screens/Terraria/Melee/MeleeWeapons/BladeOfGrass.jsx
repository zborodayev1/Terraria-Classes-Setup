          ...
          <div className='flex'>
              <div className='w-52'>
                  ...
                  <div className='flex mt-2'>
                    <img className='w-10 h-10' src='https://terraria.wiki.gg/images/9/98/Night%27s_Edge.png'/> <Link to='/melee/pre-hardmode/nightsEdge' className='mt-2 ml-2   hover:underline hover:text-blue-500 duration-200  ' >Nights Edge</Link>
                  </div>
              </div>   
              ...
              <div className='w-52 ml-2'>
                  ...
                  <div className='flex mt-1' >
                  <img className='w-10 h-10' src='/Volcano.webp'/> <Link to='/meleeWeapons' className='ml-2 text-sm    hover:underline hover:text-blue-500 duration-200  ' >Volcano</Link>
                  </div>
