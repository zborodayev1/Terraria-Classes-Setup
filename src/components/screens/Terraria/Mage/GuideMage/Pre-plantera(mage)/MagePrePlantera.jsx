              ...
              <div className='flex'>
                ...
                <div className='ml-2'>
                  ...
                  <div className='border border-gray-600 rounded-lg p-3 bg-[#101017] mt-3'>
                    ...
                    <div className='flex'>
                      <img src='/Hallowed_armor.webp' /> <Link className='h-6 mt-2' to={'/classes/HallowedArmor'}><h1 className='  hover:underline hover:text-blue-500 duration-200 ml-1'>Hallowed Armor</h1></Link>
                    </div>
                  </div>
                  <div className='border border-gray-600 rounded-lg p-3 bg-[#101017]  mt-3'>
