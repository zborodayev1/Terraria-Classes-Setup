          ...
          <div className='flex'>
              <div className='w-52'>
                  ...
                  <div className='flex mt-3'>
                    <img  src='/Spectre_Boots.webp'/> <Link to='/acs/SpectreBoots' className='mt-2 ml-2   hover:underline hover:text-blue-500 duration-200' >Spectre Boots</Link>
                  </div>
              </div>   
              ...
              <div className='w-52 ml-2'>
                  ...
                  <div className='flex mt-3' >
                  <img  src='/Rocket_Boots.webp'/> <h1  className='ml-1 text-sm font-bold' >Rocket Boots</h1>
                  </div>
              </div>
