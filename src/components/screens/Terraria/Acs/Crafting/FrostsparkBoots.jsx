          ...
          <div className='flex'>
              <div className='w-52'>
                  ...
                  <div className='flex mt-3'>
                    <img src='/Frostspark_Boots.webp'/> <h1 className='mt-2 ml-2 font-bold' >Frostspark Boots</h1>
                  </div>
              </div>   
              ...
              <div className='w-52 ml-2'>
                  ...
                  <div className='flex mt-3' >
                  <img src='/Lightning_Boots.webp'/> <Link to='/acs/LightningBoots' className='mt-2 ml-2 flex  hover:underline hover:text-blue-500 duration-200' >Lightning Boots</Link>
                  </div>
                  <div className='flex mt-3' >
