                ...
                <div className='ml-2'>
                  <div className='border border-gray-600 rounded-lg p-3  bg-[#101017]  mt-3'>
                    ...
                    <div className='flex mb-2'>
                      <img className='' src='/Tsunami.webp'/> <Link className='h-6 mt-2' to={'/ranged/Tsunami'}><h1 className=' mt-2  hover:underline hover:text-blue-500 duration-200 ml-2'>Tsunami</h1></Link>
                    </div>
