              ...
              <div className='ml-2'>
                <div className='border border-gray-600 rounded-lg p-3 bg-[#101017]  mt-3'>
                  ...
                  <div className='flex mt-2'>
                    <img className='h-6' src='/Onyx_Blaster.webp'/> <Link className='' to={'/ranged/pre-mechbosses/OnyxBlaster'}><h1 className=' hover:underline hover:text-blue-500 duration-200 ml-2'>Onyx Blaster </h1></Link>
                  </div>
                </div>
                <div className='border border-gray-600 rounded-lg p-3 bg-[#101017]  mt-3'>
                  <h1 className='font-bold'>Armor:</h1>
                  <div className='flex'>
                    <img src='/Titanium_armor_%28old%29.webp' /> <Link className='h-6 mt-2' to={'/classes/titanumArmor'}><h1 className='   hover:underline hover:text-blue-500 duration-200 ml-1'>Titanium armor</h1></Link>
                  </div>
                </div>
                <div className='border border-gray-600 rounded-lg p-3  bg-[#101017]  mt-3'>
