                ...
                <div className='ml-2'>
                  <div className='border border-gray-600 rounded-lg p-3  bg-[#101017]  mt-3'>
                    ...
                    <div className='flex mb-2 mt-2'>
                      <img className='' src='/Phantasm.webp'/> <Link className='h-6' to={'/ranged/pre-moonlord/Phantasm'}><h1 className=' mt-3  hover:underline hover:text-blue-500 duration-200 ml-2'>Phantasm</h1></Link>
                    </div>
                  </div>
                  <div className='border border-gray-600 rounded-lg p-3  bg-[#101017]  mt-3'>
